...
//import "../../styles/partials/vairables.scss"

const Header=({ onTagSelect, selectedTag }) => {
    ...
    return(
        <header className="header">
            ...
            <button
            className={`header__filter-button $(isFilterActive ? "active" : ""}`}
            onClick={handleFilterClick}>
                ...
                >
                    ...
                    stroke={isFilterActive ? "#ffffff" :  "#1E6655" }
                    strokeWidth="1.7"
                    strokeLinecap="round"
